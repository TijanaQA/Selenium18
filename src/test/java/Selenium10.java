...
public class Selenium10 {
    ...
    String validUsername, validPassword, invalidUsername, loggedInURL, invalidPassword, emptyUsernameField, emptyPasswordField;
    WebDriverWait wait;
    @BeforeClass
    public void setUp() {
    ...
    public void userCannotLogInWithEmptyUsernameField() throws InterruptedException {
        usernameField.sendKeys(emptyUsernameField);
        passwordField.sendKeys(validPassword);
        submitButton.click();
    ...
    public void userCannotLogInWithEmptyPasswordField() throws InterruptedException {
        usernameField.sendKeys(validUsername);
        passwordField.sendKeys(emptyPasswordField);
        submitButton.click();
    ...
    @Test(priority = 60)
    public void userCannotLogInWithEmptyUsernameAndPasswordFields() throws InterruptedException {
        usernameField.sendKeys(emptyUsernameField);
        passwordField.sendKeys(emptyPasswordField);
        submitButton.click();
